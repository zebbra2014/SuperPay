...
QT_MOC_LITERAL(2, 31, 0)
    ...
    "TransactionDescDialog\0stopExec\0\0"
};
...
void TransactionDescDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TransactionDescDialog *_t = static_cast<TransactionDescDialog *>(_o);
        switch (_id) {
        case 0: _t->stopExec(); break;
        default: ;
        }
        ...
        {
            typedef void (TransactionDescDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TransactionDescDialog::stopExec)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TransactionDescDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TransactionDescDialog.data,
...
// SIGNAL 0
void TransactionDescDialog::stopExec()
{
