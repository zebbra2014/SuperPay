...
public:
    ...
    void setupUi(QWidget *TransactionDescDialog)
    {
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), TransactionDescDialog, SLOT(close()));
        QObject::connect(buttonBox, SIGNAL(rejected()), TransactionDescDialog, SLOT(close()));

        QMetaObject::connectSlotsByName(TransactionDescDialog);
    } // setupUi

    void retranslateUi(QWidget *TransactionDescDialog)
    {
