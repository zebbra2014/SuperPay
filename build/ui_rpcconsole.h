...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        labelConfigfile->setObjectName(QStringLiteral("labelConfigfile"));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        ...
        openConfigurationfileButton->setObjectName(QStringLiteral("openConfigurationfileButton"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "SuperPay - Debug window", 0));
        labelConfigfile->setText(QApplication::translate("RPCConsole", "Configuration file", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SuperPay debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the SuperPay-Qt help message to get a list with possible SuperPay command-line options.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_9->setText(QApplication::translate("RPCConsole", "SuperPay Core", 0));
...
#ifndef QT_NO_TOOLTIP
        openConfigurationfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the SuperPay configuration file from the current data directory.", 0));
#endif // QT_NO_TOOLTIP
        openConfigurationfileButton->setText(QApplication::translate("RPCConsole", "O&pen", 0));
