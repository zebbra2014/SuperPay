...
struct qt_meta_stringdata_SecondAuthDialog_t {
    QByteArrayData data[7];
    char stringdata[154];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_SecondAuthDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_SecondAuthDialog_t qt_meta_stringdata_SecondAuthDialog = {
    {
QT_MOC_LITERAL(0, 0, 16),
QT_MOC_LITERAL(1, 17, 28),
QT_MOC_LITERAL(2, 46, 0),
QT_MOC_LITERAL(3, 47, 22),
QT_MOC_LITERAL(4, 70, 28),
QT_MOC_LITERAL(5, 99, 30),
QT_MOC_LITERAL(6, 130, 22)
    },
    "SecondAuthDialog\0on_addressBookButton_clicked\0"
    "\0on_pasteButton_clicked\0"
...
const QMetaObject SecondAuthDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SecondAuthDialog.data,
      qt_meta_data_SecondAuthDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SecondAuthDialog.stringdata))
